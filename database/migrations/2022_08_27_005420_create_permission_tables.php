...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->string('name', 30)->comment('for permission names');       // For MySQL 8.0 use string('name', 125);
            $table->string('group', 20)->comment('to grouping permission'); // For MySQL 8.0 use string('guard_name', 125);
            $table->string('guard_name', 10); // For MySQL 8.0 use string('guard_name', 125);
            $table->string('comment', 50)->nullable();       // For MySQL 8.0 use string('name', 125);
            $table->boolean('is_active')->default(true)->comment('To indicate when permissions group has one of CRUD rule');
            $table->timestamps();
